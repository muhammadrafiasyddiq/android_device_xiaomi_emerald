...
#define LOG_TAG "UdfpsHandler.rafi"
...
class RafiUdfpsHander : public UdfpsHandler {
  public:
  ...
  private:
    ...
    void setFingerDown(bool pressed) {
        ...
        int buf[MAX_BUF_SIZE] = {THP_FOD_DOWNUP_CTL, pressed ? 1 : 0};
        ioctl(touch_fd_.get(), TOUCH_IOC_SET_CUR_VALUE, &buf);
